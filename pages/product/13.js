...
function one() {
  ...
  const rItem = product_card.filter((item) => item.id === 13);
      ...
      <div className="flex flex-col text-sm text-center w-72 md:hidden">
        ...
        <div className="py-5">
          <div>
            ...
            <div
              className={
                isPic2 ? "h-72 w-72 xl:h-80 xl:w-80 relative" : "hidden"
              }
            >
              <Image
                className="object-contain rounded-2xl"
          ...
          <div className="grid grid-cols-3 py-5">
            ...
            <div onClick={toggleP2} className="cursor-pointer">
              <div
                className={
                  isPic2
                    ? "shadow-md rounded-2xl w-20 h-20 relative"
        ...
        <div className="text-lg">
          ...
          <div className="text-left py-2 grid grid-cols-3 gap-1">
            ...
            <p>Width:</p>
            <p className="col-start-2">Spoon:</p>
            <p>{item.spoon_width}</p>
            <p className="col-start-2">Fork:</p>
            <p>{item.fork_width}</p>
          </div>
        </div>
      </div>
      <div className="hidden md:grid grid-cols-2 gap-14">
        <div>
          <div>
            ...
            <div className={isPic2 ? "h-80 w-80 relative" : "hidden"}>
              <Image
                className="object-contain rounded-2xl"
                src={item.pic2}
                alt={item.product_name}
